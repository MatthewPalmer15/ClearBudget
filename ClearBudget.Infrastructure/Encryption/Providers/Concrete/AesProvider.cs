...
namespace ClearBudget.Infrastructure.Encryption.Providers.Concrete;
...
public class AesProvider : IEncryptionProvider
{
    ...
    public AesProvider(byte[] key, byte[] initializationVector, CipherMode mode = CipherMode.CBC,
    ...
    public byte[]? Encrypt(byte[] input)
    {
        ...
        using var aes = CreateCryptographyProvider(_key, _iv, _mode, _padding);
    ...
    ///     Please check https://blogs.msdn.microsoft.com/shawnfa/2006/10/09/the-differences-between-rijndael-and-aes/ for more
    ///     informations.
    /// </remarks>
